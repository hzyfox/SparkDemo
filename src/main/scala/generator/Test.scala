...
import ScalaReflectionUtil._
import util.JavaBase
...
case class Test(a: String, b: Array[String], c: Array[String]) {
...
class TestB(a: String, b: Array[String], c: Array[String], d: String) extends Test(a, b, c) {
...
object Test {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /**
      * 获取Test类中的doB方法， 指定doB方法的参数类型，注意用Seq结构存储类型，不要用Array，否则会出现
      * TypeTag的传递问题
      */
    val testInstance = new Test("helloWord", Array[String]("hello"), Array[String]("world"))
    ...
    /**
      * Test类中获取构造方法，指定参数类型
      */
    val testConstructor = ScalaReflectionUtil.reflectConstructorMethod[Test](
      Seq(getType[String], getType[Array[String]], getType[Array[String]]): _*)
    testConstructor("1", Array("2"), Array("3"))

    /**
      * Test类中获取构造方法，构造方法参数为空
      */
    val emptyTestConstructor = ScalaReflectionUtil.reflectConstructorMethod[Test](
      Seq[ru.Type](): _*)
    ...
    /**
      ...
      */
    val testBInstance1 = new TestB("hello", Array("world"), Array("world"), "world")
    ...
    /**
      ...
      */
    val testBInstance2 = new TestB("hello", Array("world"), Array("world"), "world")
    ...
    /**
      ...
      */
    //方法名称错误
    val testBInstance3 = new TestB("hello", Array("world"), Array("world"), "world")
    try {
    ...
    //参数类型错误
    try {
      ScalaReflectionUtil.reflectConstructorMethod[TestB](Seq(getType[Int]): _*)
    } catch {
      case e: NoSuchMethodException =>
        println(e.getMessage)
      case o: Exception =>
